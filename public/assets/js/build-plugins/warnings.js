var warningsPlugin = PHPCI.UiPlugin.extend({
    ...
    keys: {
        ...
        'phpcsdifflines-errors': 'PHPCS Diff Only changed lines Errors',
        'phpcsdifflines-warnings': 'PHPCS Diff Only changed lines Errors'
    },
    data: {},
    ...
    register: function() {
        ...
        $(window).on('phpcsdiff-warnings phpcsdiff-errors phpcsdifflines-errors phpcsdifflines-warnings', function(data) {
            self.onUpdate(data);
        });
